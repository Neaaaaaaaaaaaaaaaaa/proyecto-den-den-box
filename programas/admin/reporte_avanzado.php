...
if ($rol === null) {
    echo "<div class='container'><h1>Acceso denegado</h1><p>Inicie sesión para ver este reporte.</p><a href='../../html/comun/login.html' class='buttonplace'>Ir a login</a></div>";
    exit;
}
