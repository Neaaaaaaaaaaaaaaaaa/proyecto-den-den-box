...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if($tipo_documento === ''){
        header("Location: /proyecto-den-den-box/html/placeholders/documentos.html?status=invalid");
        exit();
    }
    ...
    if(!isset($_FILES['documento']) || $_FILES['documento']['error'] !== UPLOAD_ERR_OK){
        header("Location: /proyecto-den-den-box/html/placeholders/documentos.html?status=upload_error");
        exit();
    }
    ...
    if (!in_array($extension, $permitidos)) {
        header("Location: /proyecto-den-den-box/html/placeholders/documentos.html?status=filetype");
        exit();
    }

    if ($_FILES['documento']['size'] > 5000000) {
        header("Location: /proyecto-den-den-box/html/placeholders/documentos.html?status=filesize");
        exit();
    }
    ...
    if (move_uploaded_file($rutaTemporal, $rutaFinal)) {
        ...
        if($visibilidad === 'inmueble' && empty($id_inmueble)){
            header("Location: /proyecto-den-den-box/html/placeholders/documentos.html?status=need_inmueble");
            exit();
        }
        ...
        if($visibilidad === 'inmueble'){
            ...
            if(!$q_inm || mysqli_num_rows($q_inm) === 0){
                header("Location: /proyecto-den-den-box/html/placeholders/documentos.html?status=inmueble_not_found");
                exit();
            }
        }
        ...
        if(!mysqli_query($conexion, $sql)){
            header("Location: /proyecto-den-den-box/html/placeholders/documentos.html?status=db_error");
            exit();
        }

        header("Location: /proyecto-den-den-box/html/placeholders/documentos.html?status=ok");
        exit();
    }
