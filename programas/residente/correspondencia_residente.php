...
<title>Correspondencia - Den Den Box</title>
  ...
  <div class="container navbar">
    <a class="brand" href="../../html/residente/index_residente.html">
      ...
      <div>
        ...
        <div class="subtitle">Correspondencia</div>
      </div>
    </a>
    <nav class="nav-links">
  ...
  <section class="mail-panel">
    <div class="mail-head">
      <div>
        ...
        <p>Consulta tu correspondencia relacionada con tu inmueble.</p>
      </div>
    </div>

    <iframe src="listar_correspondencia_residente.php" class="mail-frame" title="Correspondencia del residente"></iframe>
